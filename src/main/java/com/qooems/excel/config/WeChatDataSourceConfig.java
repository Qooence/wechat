...
public class WeChatDataSourceConfig {
     ...
     */
    static final String PACKAGE = "com.qooems.excel.mapper.wechat";
    static final String MAPPER_LOCATION = "classpath:mappers/wechat/*.xml";

    /**
     * 连接数据库信息 这个其实更好的是用配置中心完成
     */
    @Value("${spring.datasource.wechat.datasource.url:#{null}}")
    private String url;

    @Value("${spring.datasource.wechat.datasource.username:#{null}}")
    private String username;

    @Value("${spring.datasource.wechat.datasource..password:#{null}}")
    private String password;

    @Value("${spring.datasource.wechat.datasource.driverClassName:#{null}}")
